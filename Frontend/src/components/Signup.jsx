  ...
  return (
    ...
    <div  className="w-[600px]">
                <div className="modal-box">
                    ...
                    <input type="text" 
                    placeholder="Enter Your Full Name" className= "w-80 px-3 py-1 rounded-md outline-none" {...register("fullname", { required: true })} />
                                        <br />
                   ...
                   <div className= "flex justify-around mt-4">
                    <button className="bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-pink-700 duration-200 cursor-pointer">Reister</button>
